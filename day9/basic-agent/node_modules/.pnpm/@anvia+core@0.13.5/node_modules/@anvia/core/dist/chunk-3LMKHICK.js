...
function attachmentToUserContent(attachment) {
  ...
  if (attachment.text !== void 0) {
    ...
    if (attachment.mediaType !== void 0) {
      source.mediaType = attachment.mediaType;
    }
    if (attachment.name !== void 0) {
...
function userContentToAttachment(content) {
  if (content.type === "image") {
    ...
    if (content.detail !== void 0) {
      attachment2.detail = content.detail;
    }
