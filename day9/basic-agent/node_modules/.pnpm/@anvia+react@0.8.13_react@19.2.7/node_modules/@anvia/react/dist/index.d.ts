...
type ToolApprovalStatus = "pending" | "approved" | "rejected" | "timed_out" | "cancelled";
type ToolApproval = {
    id: string;
    runId?: string;
    agentId?: string;
...
type ToolQuestionStatus = "pending" | "answered" | "cancelled";
